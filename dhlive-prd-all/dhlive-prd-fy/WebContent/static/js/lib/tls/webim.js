...
(function(webim) {
    ...
    var emotions = {
        ...
        "0": ["[大笑]", imgPath +'icon/nj3.gif'],
        "1": ["[转圈]", imgPath +'icon/nj4.gif'],
        "2": ["[V5]", imgPath +'icon/nj5.gif'],
        "3": ["[注册]", imgPath +'icon/nj12.gif'],
        "4": ["[涨]", imgPath +'icon/nj13.gif'],
        "5": ["[给力]", imgPath +'icon/nj14.gif'],
        "6": ["[舞蹈]", imgPath +'icon/nj15.gif'],
        "7": ["[发财]", imgPath +'icon/nj16.gif'],
        "8": ["[买]", imgPath +'icon/nj17.jpg'],
        "9": ["[早]", imgPath +'icon/nj18.gif'],
        "10": ["[鼓掌]", imgPath +'icon/nj19.gif'],
        "11": ["[抓狂]", imgPath +'icon/nj20.gif'],
        "12": ["[饿]", imgPath +'icon/nj21.gif'],
        "13": ["[耶]", imgPath +'icon/nj22.gif'],
        "14": ["[奋斗]", imgPath +'icon/nj23.gif'],
        "15": ["[赞]", imgPath +'icon/nj24.gif'],
        "16": ["[色]", imgPath +'icon/nj25.gif'],
        "17": ["[咖啡]", imgPath +'icon/nj26.gif'],
        "18": ["[顶1]", imgPath +'icon/nj1.gif'],
        "19": ["[赞1]", imgPath +'icon/nj2.gif'],
        "20": ["[顶2]", imgPath +'icon/nj6.gif'],
        "21": ["[掌声]", imgPath +'icon/nj7.gif'],
        "22": ["[鲜花]", imgPath +'icon/nj8.gif'],
        "23": ["[看涨]", imgPath +'icon/nj9.gif'],
        "24": ["[看跌]", imgPath +'icon/nj10.gif'],
        "25": ["[震荡]", imgPath +'icon/nj11.gif'],



        "26":["[花]", imgPath +"icon/flower.png"],
        "27":["[红包]", imgPath +"icon/red_pack.png"]
