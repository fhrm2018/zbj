...
(function(webim) {
    ...
    var emotions = {
        "0": ["[呵呵]", "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ac/smilea_org.gif"],
        "1": ["[妈爱你]", "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/lovea_org.gif"],
        "3": ["[太开心]", "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/58/mb_org.gif"],
        "4": ["[给力]", "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c9/geili_org.gif"],

        "12": ["[鼓掌]", imgPath +"icon/s_1.gif"],
        "13": ["[抠鼻子]", imgPath +"icon/s_2.gif"],
        "14": ["[头疼]", imgPath +"icon/s_3.gif"],
        "15": ["[饿了]", imgPath +"icon/s_4.gif"],
        "16": ["[好的]", imgPath +"icon/s_5.gif"],
        "17": ["[奋斗]", imgPath +"icon/s_6.gif"],
        "18": ["[亲]", imgPath +"icon/s_7.gif"],
        "19": ["[强]", imgPath +"icon/s_8.gif"],
        "21": ["[调皮]", imgPath +"icon/s_10.gif"],
        "22": ["[色]", imgPath +"icon/s_11.gif"],
        "23": ["[抛媚眼]", imgPath +"icon/s_12.gif"],
        "24": ["[休息]", imgPath +"icon/s_13.gif"],
        // "25": ["[喝茶]", imgPath +"icon/q1.gif"],
        // "26": ["[果汁]", imgPath +"icon/q2.gif"],
        // "27": ["[荡秋天]", imgPath +"icon/q3.gif"],
        // "28": ["[抱抱]", imgPath +"icon/q4.gif"],
        // "29": ["[嫌弃]", imgPath +"icon/q5.gif"],
        // "30": ["[谢谢]", imgPath +"icon/q6.gif"],
        // "31": ["[嗯嗯]", imgPath +"icon/q7.gif"],
        "32": ["[哈哈]", imgPath +"icon/q8.gif"],
        // "33": ["[喜欢]", imgPath +"icon/q9.gif"],
        // "35": ["[哭]", imgPath +"icon/q11.gif"],
        // "36": ["[加油]", imgPath +"icon/q12.gif"],
        // "37": ["[睡觉]", imgPath +"icon/q13.gif"],
        // "38": ["[干杯]", imgPath +"icon/q14.gif"],
        // "39": ["[凉了]", imgPath +"icon/q15.gif"],
        // "40": ["[收藏]", imgPath +"icon/q16.gif"],
        "41": ["[小心心]", imgPath +"icon/q17.gif"],
        // "42": ["[害羞]", imgPath +"icon/q18.gif"],
        // "44": ["[买买买]", imgPath +"icon/q20.gif"],
        // "45": ["[吃零食]", imgPath +"icon/q21.gif"],
        // "46": ["[没钱了]", imgPath +"icon/q22.gif"],
        // "47": ["[观察]", imgPath +"icon/q23.gif"],
        // "48": ["[疑问]", imgPath +"icon/q24.gif"],
        // "49": ["[亲亲]", imgPath +"icon/q26.gif"],
        // "50": ["[去旅行]", imgPath +"icon/q27.gif"],
        // "51": ["[转球]", imgPath +"icon/q28.gif"],
        // "52": ["[不开心]", imgPath +"icon/q29.gif"],
        // "53": ["[做饭]", imgPath +"icon/q30.gif"],
        // "54": ["[大笑]", imgPath +"icon/q31.gif"],
        "55": ["[加油2]", imgPath +"icon/q32.gif"],
        // "56": ["[乖]", imgPath +"icon/q33.gif"],
        // "57": ["[泡脚]", imgPath +"icon/q34.gif"],
        // "58": ["[听音乐]", imgPath +"icon/q35.gif"],
        // "59": ["[打豆豆]", imgPath +"icon/q36.gif"],
        // "60": ["[生气]", imgPath +"icon/q37.gif"],
        // "61": ["[骑木马]", imgPath +"icon/q38.gif"],
        // "62": ["[宝宝]", imgPath +"icon/q39.gif"],
        // "63": ["[思考]", imgPath +"icon/q40.gif"],
        // "64": ["[奸笑]", imgPath +"icon/q41.gif"],
        // "65": ["[拉二胡]", imgPath +"icon/q42.gif"],
        // "66": ["[飞]", imgPath +"icon/q43.gif"],
        // "67": ["[看蚂蚁]", imgPath +"icon/q44.gif"],
        // "68": ["[放松]", imgPath +"icon/q45.gif"],
        // "69": ["[非常棒]", imgPath +"icon/q46.gif"],
        // "70": ["[踩水]", imgPath +"icon/q47.gif"],
        // "71": ["[哼]", imgPath +"icon/q48.gif"],
        // "72": ["[骄傲]", imgPath +"icon/q49.gif"],
        // "73": ["[要么]", imgPath +"icon/q50.gif"],
        // "74": ["[晃头]", imgPath +"icon/q51.gif"],
        // "75": ["[无奈]", imgPath +"icon/q52.gif"],
        // "76": ["[叹气]", imgPath +"icon/q53.gif"],
        // "77": ["[晚安]", imgPath +"icon/q54.gif"],
        // "78": ["[要坚强]", imgPath +"icon/q55.gif"],
        // "79": ["[下雨了]", imgPath +"icon/q56.gif"],
        // "80": ["[UFO]", imgPath +"icon/q57.gif"],
        // "81": ["[扭脸]", imgPath +"icon/q58.gif"],
        // "82": ["[伤心]", imgPath +"icon/q59.gif"],
        // "83": ["[冲浪]", imgPath +"icon/q60.gif"],
        // "84": ["[抱自己]", imgPath +"icon/q61.gif"],
        // "85": ["[亲这里]", imgPath +"icon/q62.gif"],
        // "86": ["[期待]", imgPath +"icon/q63.gif"],
        // "87": ["[喝彩]", imgPath +"icon/q64.gif"],
        // "88": ["[晒太阳]", imgPath +"icon/q66.gif"],

        "89": ["[k线]", imgPath +'icon/q67.gif'],
        "90": ["[跌]", imgPath +'icon/q68.gif'],
        "91": ["[跌2]", imgPath +'icon/q69.gif'],
        "92": ["[发财]", imgPath +'icon/q70.gif'],
        "93": ["[空军]", imgPath +'icon/q71.gif'],
        "94": ["[厉害了]", imgPath +'icon/q72.jpg'],
        "95": ["[买]", imgPath +'icon/q73.jpg'],
        "96": ["[漂亮]", imgPath +'icon/q74.gif'],
        "97": ["[瀑布]", imgPath +'icon/q75.gif'],
        "98": ["[掐指]", imgPath +'icon/q76.gif'],
        "99": ["[出来呀]", imgPath +'icon/q77.gif'],
        "100": ["[早上好]", imgPath +'icon/q78.gif'],
        "101": ["[涨1]", imgPath +'icon/q79.gif'],
        "102": ["[涨2]", imgPath +'icon/q84.gif'],
        "103": ["[涨3]", imgPath +'icon/q88.gif'],
        "104": ["[暴跌3]", imgPath +'icon/q80.gif'],
        "105": ["[暴跌4]", imgPath +'icon/q81.gif'],
        "106": ["[暴跌5]", imgPath +'icon/q83.jpg'],
        "107": ["[跌6]", imgPath +'icon/q86.gif'],
        "108": ["[呲牙]", imgPath +'icon/q82.gif'],
        "109": ["[牛]", imgPath +'icon/q85.gif'],
        "110": ["[晚安]", imgPath +'icon/q87.gif'],


        "111":["[花]", imgPath +"icon/flower.png"],
        "112":["[红包]", imgPath +"icon/red_pack.png"]
    }
