...
//  	                    window.location.href = g_requestContextPath + "/user/userRegistered";
    ...
    function autoWindow(num1, num2) {
        ...
        if (screenWidth <= 1600) {
            $(".headBtns").attr('class', "headBtns topLeft fl wImg1400");
            ...
            // none(3);
            $(".headBtns").attr('class', "headBtns topLeft fl wImg1700");
            ...
            // none(num2);
            $(".headBtns").attr('class', "headBtns topLeft fl");
        ...
        var videoHeight = winHeight - 40 - 160 - 70 - 40;        // 40 footer; 166 banner margin; 80 header margin; 44 viewTime;
        var contentRightMsg = winHeight - 70 - serviceListHeight - messageBoxHeight - 30 - 30 - tishiHeight;
        var newLeft = winHeight - 80 - 40;
...
// var btns = $(".tBtn a");
// var child = $(".tCon .imgList");
$(".tBtn a").each(function (index) {
    $(this).click(function () {
        $(".tBtn a").removeClass("cur");
        $(".tCon .imgList").hide();
        $(this).addClass('cur');
        $(".tCon .imgList").eq(index).show()
    })
});

function rightBtn(){
    $('.rightSuspension').show();
    $('.tqBtn').hide();
}
function rightClose(){
    $('.tqBtn').show();
    $('.rightSuspension').hide();
}
...
$(".rightSuspension a").hover(function(){
    $(this).css('right','-40px')
},function(){
    $(this).css('right','-50px')
})
