...
//  	                    window.location.href = g_requestContextPath + "/user/userRegistered";
    ...
    function autoWindow(num1, num2) {
        ...
        var videoHeight = winHeight - 40 - 150 - 70 - 36;        // 40 footer; 150 banner margin; 70 header margin; 44 viewTime;
        var contentRightMsg = winHeight - 70 - serviceListHeight - messageBoxHeight - 40 - 32 - tishiHeight;
