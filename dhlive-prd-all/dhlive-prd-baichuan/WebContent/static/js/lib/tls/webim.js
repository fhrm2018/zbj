...
(function(webim) {
    ...
    var emotions = {
        ...
        "0": ["[膜拜]", imgPath +'icon/mobai.gif'],
        "1": ["[欢迎]", imgPath +'icon/huanying.gif'],
        "2": ["[囧]", imgPath +'icon/jiong.gif'],
        "3": ["[酷]", imgPath +'icon/ku.gif'],
        "4": ["[中国]", imgPath +'icon/zhongguo.gif'],
        "5": ["[顶]", imgPath +'icon/ding.gif'],
        "6": ["[委屈]", imgPath +'icon/weiqu.gif'],
        "7": ["[奸笑]", imgPath +'icon/jianxiao.gif'],
        "8": ["[无聊]", imgPath +'icon/wuliao.gif'],
        "9": ["[飞吻]", imgPath +'icon/feiwen.gif'],
        "10": ["[哈哈]", imgPath +'icon/haha.gif'],
        "11": ["[努力]", imgPath +'icon/nvli.gif'],
        "12": ["[撒钱]", imgPath +'icon/saqian.gif'],
        "13": ["[潜水]", imgPath +'icon/qianshui.gif'],
        "14": ["[震惊]", imgPath +'icon/zhenjing.gif'],
        "15": ["[晕]", imgPath +'icon/yun.gif'],
        "16": ["[疑问]", imgPath +'icon/yiwen.gif'],
        // "17": ["[早]", imgPath +'icon/zao.gif'],
        // "18": ["[晚上好]", imgPath +'icon/wan.gif'],
        // "19": ["[晚安]", imgPath +'icon/wanan.gif'],
        "21": ["[恭喜]", imgPath +'icon/gongxi.gif'],
        "22": ["[摆手]", imgPath +'icon/baishou.gif'],
        "23": ["[种钱]", imgPath +'icon/zhongqian.gif'],
        "24": ["[嘿嘿]", imgPath +'icon/hei.gif'],
        "25": ["[石化]", imgPath +'icon/shihuan.gif'],
        "26": ["[得意]", imgPath +'icon/duanlian.gif'],
        "27": ["[早上好]", imgPath +'icon/zao.gif'],
        "28": ["[中午好]", imgPath +'icon/zhong.gif'],
        "29": ["[晚上好]", imgPath +'icon/wan.gif'],
        "30": ["[晚安]", imgPath +'icon/wanan.gif'],
        "31": ["[晚安]", imgPath +'icon/zaijian.gif'],
        "32": ["[火箭]", imgPath +'icon/huojian.gif'],
