    ...
    <div class="mainBox flexCon">
        <div class="mainSearch">
            ...
            <div class="posAbs" style="right: 10px; top: 20px;">
                <button type="button" class="pageBtn uploadBtn">上传课件</button>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/static/modules/live/file.js"></script>
</html>