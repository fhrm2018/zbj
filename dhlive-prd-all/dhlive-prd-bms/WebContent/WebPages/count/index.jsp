              ...
              <div class="clearfix">
                    ...
                    <div class="serTag mr10 verTop ar fl">统计时间</div>
                 	 <div tabindex="0" class="serSelect fl posRel mr10 showSelectTime">
                        <input type="text" id="beginDate" name="beginDate" class="serIpt serIptNar fl date-hook" onfocus="WdatePicker()" />
                        <span class="serToTxt block fl ac">至</span>
                        <input type="text" id="endDate" name="endDate" class="serIpt serIptNar fl date-hook" onfocus="WdatePicker()"/>
                    </div>			
              </div>
              </form>
        </div>
