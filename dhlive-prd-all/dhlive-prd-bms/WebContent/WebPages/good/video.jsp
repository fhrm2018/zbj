...
<div id="addWin" class="popForm popFormWide wtBg posFixed hide" style="width: 600px">
    <form id="tableForm" action="${pageContext.request.contextPath}/goods/saveVideo" method="post">
        ...
        <div class="wtBg ac" style="padding-bottom: 15px;">
            <span class="formLabel ar mr10">标题</span>
            <input type="text" class="serIpt" name="videoTitle" placeholder="标题"/>
        </div>

        <div class="wtBg ptb10 ac">
            <span class="formLabel ar mr10">封面</span>
            <input type="file" class="serIpt" name="fm"/>
        </div>

        <div class="wtBg ptb10 ac">
            <span class="formLabel ar mr10">视频</span>
            <input type="file" class="serIpt" name="sp"/>
        </div>

        <div class="wtBg ac" style="padding-bottom: 15px;">
            <span class="formLabel ar mr10">观看人数</span>
            <input type="text" class="serIpt" name="watchCount" placeholder="观看人数"/>
        </div>

        <div class="wtBg ptb10">
            <textarea id="content" name="videoContent"></textarea>
        </div>
...
<script src="${pageContext.request.contextPath}/static/modules/good/video.js"></script>
</html>