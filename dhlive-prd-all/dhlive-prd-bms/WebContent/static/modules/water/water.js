...
$(function () {
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            var record = obj[i];
               ...
               '<div class="flexWrap flexAgCen" style="width: 15%; text-align:center;  min-height: 70px;""> <div class="flexCon"> '
                + record.fromNickName + '</div></div>',

                '<div class="flexWrap flexAgCen" style="width: 15%; text-align:center; "> <div class="flexCon"> '
                + record.toNickName + '</div></div>',
                '<div class="flexWrap flexAgCen" style="width: 50%; text-align:center; "> <div class="flexCon"> '
    ...
    getDataList = function () {
        $.ajaxGetData({
            "ajaxUrl": g_requestContextPath + "/water/getWaterList",
            "fnData": fnData,
            "postData": prame,
            "headtype": 1
        });
    ...
    $('.backBtn').on('click', function () {
        window.location.href=g_requestContextPath+"/water";
    });
