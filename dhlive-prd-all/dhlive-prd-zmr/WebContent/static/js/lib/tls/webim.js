...
(function(webim) {
    ...
    var emotions = {
        ...
        // "0": ["[得意]", 'http://image.xunbaoqu.com/images/icon/deyi.gif'],
        "1": ["[调皮]", '//image.xunbaoqu.com/images/icon/tiaopi.gif'],
        // "2": ["[呲牙]", 'http://image.xunbaoqu.com/images/icon/ciya.gif'],
        "3": ["[酷]", '//image.xunbaoqu.com/images/icon/ku.gif'],
        "4": ["[偷笑]", '//image.xunbaoqu.com/images/icon/touxiao.gif'],
        "5": ["[可爱]", '//image.xunbaoqu.com/images/icon/keai.gif'],
        "6": ["[憨笑]", '//image.xunbaoqu.com/images/icon/haha.gif'],
        "7": ["[奋斗]", '//image.xunbaoqu.com/images/icon/fendou.gif'],
        "8": ["[再见]", '//image.xunbaoqu.com/images/icon/zaijian.gif'],
        "9": ["[挖鼻]", '//image.xunbaoqu.com/images/icon/wabi.gif'],
        "10": ["[鼓掌]", '//image.xunbaoqu.com/images/icon/guzhang.gif'],
        // "11": ["[坏笑]", '//image.xunbaoqu.com/images/icon/huaixiao.gif'],
        // "12": ["[玫瑰]", '//image.xunbaoqu.com/images/icon/hua.gif'],
        "13": ["[拥抱]", '//image.xunbaoqu.com/images/icon/yongbao.gif'],
        "14": ["[强]", '//image.xunbaoqu.com/images/icon/qiang.gif'],
        "15": ["[佩服]", '//image.xunbaoqu.com/images/icon/peifu.gif'],
        "16": ["[勾引]", '//image.xunbaoqu.com/images/icon/gouyin.gif'],
        "17": ["[干杯]", '//image.xunbaoqu.com/images/icon/cheer.gif'],
        "18": ["[OK]", '//image.xunbaoqu.com/images/icon/ok.gif'],
        "19": ["[给力]", '//image.xunbaoqu.com/images/icon/geili.gif'],


        "21": ["[好]", '//image.xunbaoqu.com/images/icon/z1.gif'],
        "22": ["[爱你呦]", '//image.xunbaoqu.com/images/icon/z2.gif'],
        "23": ["[锤子]", '//image.xunbaoqu.com/images/icon/z3.gif'],
        "24": ["[发力]", '//image.xunbaoqu.com/images/icon/z4.gif'],
        "25": ["[海哥棒]", '//image.xunbaoqu.com/images/icon/z5.gif'],
        "26": ["[火箭]", '//image.xunbaoqu.com/images/icon/z6.gif'],
        "27": ["[莫愁1]", '//image.xunbaoqu.com/images/icon/z7.gif'],
        "28": ["[莫愁2]", '//image.xunbaoqu.com/images/icon/z8.gif'],
        "29": ["[莫渊]", '//image.xunbaoqu.com/images/icon/z9.gif'],
        "30": ["[你真棒]", '//image.xunbaoqu.com/images/icon/z10.gif'],
        "31": ["[撒娇]", '//image.xunbaoqu.com/images/icon/z11.gif'],
        "32": ["[朝大海]", '//image.xunbaoqu.com/images/icon/z12.gif'],
        "33": ["[楼外楼]", '//image.xunbaoqu.com/images/icon/z13.gif'],
        "34": ["[谁最狂]", '//image.xunbaoqu.com/images/icon/z14.gif'],
        "35": ["[悠闲]", '//image.xunbaoqu.com/images/icon/z15.gif'],





        "36": ["[呲牙]", '//image.xunbaoqu.com/images/icon/ciya.gif'],
        "37": ["[大兵]", '//image.xunbaoqu.com/images/icon/dabing.gif'],
        "38": ["[大哭]", '//image.xunbaoqu.com/images/icon/daku.gif'],
        "39": ["[得意]", '//image.xunbaoqu.com/images/icon/deyi.gif'],
        "40": ["[发呆]", '//image.xunbaoqu.com/images/icon/fadai.gif'],
        "41": ["[害羞]", '//image.xunbaoqu.com/images/icon/haixiu.gif'],
        "42": ["[坏笑]", '//image.xunbaoqu.com/images/icon/huaixiao.gif'],
        "43": ["[流汗]", '//image.xunbaoqu.com/images/icon/liuhan.gif'],
        "44": ["[色]", '//image.xunbaoqu.com/images/icon/se.gif'],
        "45": ["[生气]", '//image.xunbaoqu.com/images/icon/shengqi.gif'],
        "46": ["[吐血]", '//image.xunbaoqu.com/images/icon/tuxue.gif'],
        "47": ["[微笑]", '//image.xunbaoqu.com/images/icon/weixiao.gif'],
        "48": ["[吓]", '//image.xunbaoqu.com/images/icon/xia.gif'],
        "49": ["[笑哭]", '//image.xunbaoqu.com/images/icon/xiaoku.gif'],
        "50": ["[晕]", '//image.xunbaoqu.com/images/icon/yun.gif'],
        "51": ["[玫瑰]", '//image.xunbaoqu.com/images/icon/hua.gif'],


        "52":["[花]", "//image.xunbaoqu.com/images/icon/flower.png"],
        "53":["[红包]", "//image.xunbaoqu.com/images/icon/red_pack.png"]
