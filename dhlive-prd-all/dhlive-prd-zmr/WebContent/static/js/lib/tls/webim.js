...
(function(webim) {
    ...
    var emotions = {
        ...
        // "0": ["[得意]", imgPath +'icon/deyi.gif'],
        "1": ["[调皮]", imgPath +'icon/tiaopi.gif'],
        // "2": ["[呲牙]", imgPath +'icon/ciya.gif'],
        "3": ["[酷]", imgPath +'icon/ku.gif'],
        "4": ["[偷笑]", imgPath +'icon/touxiao.gif'],
        "5": ["[可爱]", imgPath +'icon/keai.gif'],
        "6": ["[憨笑]", imgPath +'icon/haha.gif'],
        "7": ["[奋斗]", imgPath +'icon/fendou.gif'],
        "8": ["[再见]", imgPath +'icon/zaijian.gif'],
        "9": ["[挖鼻]", imgPath +'icon/wabi.gif'],
        "10": ["[鼓掌]", imgPath +'icon/guzhang.gif'],
        // "11": ["[坏笑]", imgPath +'icon/huaixiao.gif'],
        // "12": ["[玫瑰]", imgPath +'icon/hua.gif'],
        "13": ["[拥抱]", imgPath +'icon/yongbao.gif'],
        "14": ["[强]", imgPath +'icon/qiang.gif'],
        "15": ["[佩服]", imgPath +'icon/peifu.gif'],
        "16": ["[勾引]", imgPath +'icon/gouyin.gif'],
        "17": ["[干杯]", imgPath +'icon/cheer.gif'],
        "18": ["[OK]", imgPath +'icon/ok.gif'],
        "19": ["[给力]", imgPath +'icon/geili.gif'],


        "21": ["[好]", imgPath +'icon/z1.gif'],
        "22": ["[爱你呦]", imgPath +'icon/z2.gif'],
        "23": ["[锤子]", imgPath +'icon/z3.gif'],
        "24": ["[发力]", imgPath +'icon/z4.gif'],
        "25": ["[海哥棒]", imgPath +'icon/z5.gif'],
        "26": ["[火箭]", imgPath +'icon/z6.gif'],
        "27": ["[莫愁1]", imgPath +'icon/z7.gif'],
        "28": ["[莫愁2]", imgPath +'icon/z8.gif'],
        "29": ["[莫渊]", imgPath +'icon/z9.gif'],
        "30": ["[你真棒]", imgPath +'icon/z10.gif'],
        "31": ["[撒娇]", imgPath +'icon/z11.gif'],
        "32": ["[朝大海]", imgPath +'icon/z12.gif'],
        "33": ["[楼外楼]", imgPath +'icon/z13.gif'],
        "34": ["[谁最狂]", imgPath +'icon/z14.gif'],
        "35": ["[悠闲]", imgPath +'icon/z15.gif'],





        "36": ["[呲牙]", imgPath +'icon/ciya.gif'],
        "37": ["[大兵]", imgPath +'icon/dabing.gif'],
        "38": ["[大哭]", imgPath +'icon/daku.gif'],
        "39": ["[得意]", imgPath +'icon/deyi.gif'],
        "40": ["[发呆]", imgPath +'icon/fadai.gif'],
        "41": ["[害羞]", imgPath +'icon/haixiu.gif'],
        "42": ["[坏笑]", imgPath +'icon/huaixiao.gif'],
        "43": ["[流汗]", imgPath +'icon/liuhan.gif'],
        "44": ["[色]", imgPath +'icon/se.gif'],
        "45": ["[生气]", imgPath +'icon/shengqi.gif'],
        "46": ["[吐血]", imgPath +'icon/tuxue.gif'],
        "47": ["[微笑]", imgPath +'icon/weixiao.gif'],
        "48": ["[吓]", imgPath +'icon/xia.gif'],
        "49": ["[笑哭]", imgPath +'icon/xiaoku.gif'],
        "50": ["[晕]", imgPath +'icon/yun.gif'],
        "51": ["[玫瑰]", imgPath +'icon/hua.gif'],


        "52":["[花]", imgPath +"icon/flower.png"],
        "53":["[红包]", imgPath +"icon/red_pack.png"]
