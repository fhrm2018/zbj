...
(function(webim) {
    ...
    var emotions = {
            ...
            "0": ["[得意]", imgPath +'icon/deiyi.gif'],
            "1": ["[调皮]", imgPath +'icon/tiaopi.gif'],
            "2": ["[偷笑]", imgPath +'icon/touxiao.gif'],
            "3": ["[再见]", imgPath +'icon/zaijian.gif'],
            "4": ["[挖鼻]", imgPath +'icon/koubi.gif'],
            "5": ["[鼓掌]", imgPath +'icon/guzhang.gif'],
            "6": ["[呲牙]", imgPath +'icon/ziya.gif'],
            // "7": ["[大兵]", imgPath +'icon/dabing.gif'],
            "8": ["[鄙视]", imgPath +'icon/bishi.gif'],
            "9": ["[大哭]", imgPath +'icon/daku.gif'],
            "10": ["[发呆]", imgPath +'icon/fadai.gif'],
            "11": ["[害羞]", imgPath +'icon/haixiu.gif'],
            "12": ["[流汗]", imgPath +'icon/liuhan.gif'],
            "13": ["[色]", imgPath +'icon/se.gif'],
            "14": ["[生气]", imgPath +'icon/shengqi.gif'],
            "15": ["[微笑]", imgPath +'icon/weixiao.gif'],
            "16": ["[吓]", imgPath +'icon/xia.gif'],
            "17": ["[晕]", imgPath +'icon/yun.gif'],
            "18": ["[疑问]", imgPath +'icon/yiwen.gif'],
            "19": ["[亲亲]", imgPath +'icon/qin.gif'],
            // "20": ["[阴险]", imgPath +'icon/yinxian.gif'],
            "21": ["[敲打]", imgPath +'icon/qiaoda.gif'],
            "22": ["[惊恐]", imgPath +'icon/jingkong.gif'],
            "23": ["[可怜]", imgPath +'icon/kelian.gif'],


            "24": ["[恭喜]", imgPath +'icon/gongxi.gif'],
            "25": ["[赞]", imgPath +'icon/zan.gif'],
            "26": ["[过年]", imgPath +'icon/nian.gif'],
            "27": ["[发财]", imgPath +'icon/facai.gif'],
            "28": ["[回头]", imgPath +'icon/hui.gif'],
            "29": ["[加油]", imgPath +'icon/jiayou.gif'],
            "30": ["[发财2]", imgPath +'icon/fa2.gif'],
            "31": ["[起飞]", imgPath +'icon/qifei.gif'],
            "32": ["[火箭1]", imgPath +'icon/huojian1.gif'],
            "33": ["[火箭2]", imgPath +'icon/huojian2.gif'],
            "34": ["[火箭3]", imgPath +'icon/huojian3.gif'],
            "35": ["[火箭4]", imgPath +'icon/huojian4.gif'],
            "36": ["[瀑布]", imgPath +'icon/pubu.gif'],
