...
(function(webim) {
    ...
    var emotions = {
        ...
        "0": ["[呲牙]", imgPath +'icon/ciya.gif'],
        "1": ["[得意]", imgPath +'icon/deyi.gif'],
        "2": ["[害羞]", imgPath +'icon/haixiu.gif'],
        "3": ["[色]", imgPath +'icon/se.gif'],
        "4": ["[调皮]", imgPath +'icon/tiaopi.gif'],
        "5": ["[发财]", imgPath +'icon/facai.gif'],
        "6": ["[鼓掌1]", imgPath +'icon/gz1.gif'],
        "7": ["[鼓掌2]", imgPath +'icon/gz2.gif'],
        "8": ["[鼓掌3]", imgPath +'icon/gz3.gif'],
        ...
        "16": ["[瀑布]", imgPath +'icon/pubu.gif'],
        "17": ["[潜水]", imgPath +'icon/qianshui.gif'],
        "18": ["[快涨]", imgPath +'icon/kz.gif'],
        "19": ["[元宝]", imgPath +'icon/yuanbao.gif'],
        "21": ["[赞]", imgPath +'icon/zan.gif'],
        "22": ["[谢谢]", imgPath +'icon/xiexie.gif'],
        "23": ["[早上好]", imgPath +'icon/zao.gif'],
        "24": ["[支持]", imgPath +'icon/zhichi.gif'],
        "25": ["[嗨起来]", imgPath +'icon/hai.gif'],
        "26": ["[等收割]", imgPath +'icon/shouge.gif'],
        "27": ["[抓狂]", imgPath +'icon/paizhuo.gif'],
        "28": ["[火箭1]", imgPath +'icon/hj1.gif'],
