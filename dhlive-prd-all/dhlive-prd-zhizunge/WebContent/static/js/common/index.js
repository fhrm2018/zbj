...
//  	                    window.location.href = g_requestContextPath + "/user/userRegistered";
    ...
    function autoWindow(num1, num2) {
        ...
        var videoHeight = winHeight - 40 - 150 - 60 - 46 - 90 - 35;        // 40 footer; 150 banner margin; 60 header margin; 46 viewTime;
        var contentRightMsg = winHeight - 60 - messageBoxHeight - 94 - 76 - tishiHeight - 35;
